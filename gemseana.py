...
# This file contains Python3 functions I use for my GeMSE analysis.
...
# paths
relpath_mvs_gemse_root_scripts = "./GeMSE_ROOT_scripts/"
relpath_mvs_gemse_analysis = "./GeMSE_analysis/"
relpath_analysis_input = "./analysis_input_files/"
relpath_background_files = relpath_analysis_input +"./background/"
relpath_calibration_files = relpath_analysis_input +"./calibration/"
relpath_efficiency_simulation_files = relpath_analysis_input +"./efficiency_simulation/"
relpath_isotope_data_files = relpath_analysis_input +"./isotope_data/"
relpath_resolution_files = relpath_analysis_input +"./energy_resolution/"
...
# filenames
filename_final_calibrated_added_spectrum = "final_calibrated_added_spectrum.root" # name of the .root file of the final (i.e., summarized and calibrated) spectrum fed into Moritz' 'GeMSE_analysis' script
filename_analysis_configuration_file = "analysis_configuration_file.txt" # name of the .txt file fed into Moritz' 'GeMSE_analysis' script
filename_analysis_summary = "analysis_summary"
filename_analysis_summary_txt = filename_analysis_summary +".txt"
filename_analysis_summary_wiki = filename_analysis_summary +"_wiki.txt"
filename_analysis_summary_json = filename_analysis_summary +".json"
filename_activities_summary = "_activities_summary.txt" # set by Moritz von Sivers' script
...
###############################################################
### wrapper functions for Moritz von Sivers' analysis scripts #
###############################################################
...
def make_rootfile_list(
    ...
    input_abspath_gemse_root_scripts):
...
def plot_rate(
    input_pathstring_root_file, # pathstring referring to the utilized root file
    input_abspath_gemse_root_scripts,
...
def gemse_analysis(
    input_pathstring_gemse_analysis_configuration_file,
    input_abspath_gemse_analysis):
...
def all_in_one_gemse_analysis(
    ...
    input_abspath_gemse_root_scripts, # abspath of Moritz' 'GeMSE_ROOT_scripts' scripts
    input_abspath_gemse_analysis): # abspath of Moritz' 'GeMSE_analysis' scripts
