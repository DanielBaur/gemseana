...
# paths
relpath_gemseana = "./gemseana/"
relpath_mvs_gemse_root_scripts = relpath_gemseana +"./GeMSE_ROOT_scripts/"
relpath_mvs_gemse_analysis = relpath_gemseana +"./GeMSE_analysis/"
relpath_analysis_input = relpath_gemseana +"./analysis_input_files/"
relpath_backgrounds = relpath_analysis_input +"./background/"
relpath_calibrations = relpath_analysis_input +"./calibration/"
relpath_efficiency_simulations = relpath_analysis_input +"./efficiency_simulation/"
relpath_isotope_data = relpath_analysis_input +"./isotope_data/"
...
# filenames
filename_analysis_summary_files = "_analysis_summary"
